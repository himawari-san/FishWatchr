...
public class MainFrame extends JFrame {
	...
	private static final String VERSION = "Ver.0.9.16 [20200725]"; //$NON-NLS-1$
	private static final String COPYRIGHT = "Copyright(c) 2014-2020 Masaya YAMAGUCHI"; //$NON-NLS-1$
