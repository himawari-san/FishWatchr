...
public class MainFrame extends JFrame {
	...
	private static final String VERSION = "Ver.0.9.10 [20171221]";
	private static final String COPYRIGHT = "Copyright(c) 2014-2017 Masaya YAMAGUCHI";
	...
	private JMenuItem getJMenuItemAnalysis(final int chartStyle, final String mode){
		...
		menuItem.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(results.size() == 0){
					JOptionPane.showMessageDialog(null,  "表示するデータがありません。");
					return;
				}
