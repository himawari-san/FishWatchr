...
public class AnnotationSelectPanel extends JPanel {
	private static final long serialVersionUID = 1L;
	private static final int MAX_COMMENT_TYPE = 8;
	...
	public AnnotationSelectPanel(List<CommentType> commentTypes){
		this.commentTypes = commentTypes;
		annotationNames = new JTextField[MAX_COMMENT_TYPE];
		markColors = new JButton[MAX_COMMENT_TYPE];
